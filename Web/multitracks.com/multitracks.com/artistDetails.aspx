		...
		<div class="wrapper mod-standard mod-gray">
			<div class="details-banner">
				...
				<div class="details-banner--hero">
					<asp:Image class="details-banner--hero--img" runat="server" ID="bannerImage"/>
				</div>
				<div class="details-banner--info">
					<a href="#" class="details-banner--info--box">
						<asp:Image class="details-banner--info--box--img" runat="server" ID="profileImage"/>
					</a>
					<h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#"><asp:Label runat="server" ID="artistName"></asp:Label></a></h1>
				</div>
			</div>
										...
										<ItemTemplate>
											<li class="song-list--item media-player--row">
												<div class="song-list--item--player-img media-player">
													<asp:Image class="song-list--item--player-img--img" runat="server" ImageUrl='<%# Eval("albumURL") %>' />
												</div>
								...
								<section class="standard--holder">
									...
									<div class="discovery--grid-holder">
										<div class="ly-grid ly-grid-cranberries">
											<asp:Repeater ID="mediaRepeater" runat="server">
												<ItemTemplate>
													<div class="media-item">
														<a class="media-item--img--link" href='#' tabindex="0">
															<img class="media-item--img" src='<%# Eval("imageUrl") %>'>
															<span class="image-tag"><%# Eval("year") %></span>
														</a>
														<a class="media-item--title" href="#" tabindex="0"><%# Eval("title") %></a>
														<a class="media-item--subtitle" href="#" tabindex="0"><%# artist.title %></a>
													</div>
												</ItemTemplate>
											</asp:Repeater>
										</div><!-- /.grid -->
...
<script>
	...
	function readMore(elementToShow, elementToHide) {
